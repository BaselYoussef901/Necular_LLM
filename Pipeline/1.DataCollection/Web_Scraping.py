...
class KeywordsManager:
    def __init__(self, keywords=None):
        """
        Initialize keywords Manager with a list of keywords.
    ...
    def add_keywords(self, new_keywords):
        ...
        Args:
            new_keywords (list): a list of new keywords
        """
    ...
    def remove_keywords(self, keywords_to_remove):
        ...
        Args:
            keywords_to_remove (list): a list of keywords to be removed.
        """
    ...
    def update_keywords(self, keywords):
        ...
        Args:
            keywords (list): a new list of keywords replacing old list.
        """
